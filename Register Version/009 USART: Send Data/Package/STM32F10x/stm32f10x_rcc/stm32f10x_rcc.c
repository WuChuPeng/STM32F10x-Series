...
void __RCC_INIT(void)
{
  ...
  #if (USE_BSP_KEY > 0u) || (USE_PERIPHERAL_USART1 > 0u)
  RCC->APB2ENR |= 0x00000004; // GPIOA clock enabled
  #endif
  #if (USE_BSP_LED > 0u) || (USE_BSP_BEEP > 0u)
  RCC->APB2ENR |= 0x00000008; // GPIOB clock enabled
  #endif
  #if (USE_BSP_LED > 0u) || (USE_BSP_KEY > 0u)
  RCC->APB2ENR |= 0x00000040; // GPIOE clock enabled
  #endif
  #if (USE_PERIPHERAL_USART1 > 0u)
  RCC->APB2ENR |= 0x00004000; // USART1 clock enabled
  #endif
}
